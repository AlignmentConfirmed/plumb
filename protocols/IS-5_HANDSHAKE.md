...
Generated by `datum/tests/wire_suite.rs (mod vectors)::the_hello_vector` and
...
- **Whether `datum::session::Hello` should follow.** `datum` carries a
  ...
  `datum/tests/wire_suite.rs (mod vectors)` generates V13 from that implementation and
